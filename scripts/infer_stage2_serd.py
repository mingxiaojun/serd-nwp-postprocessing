# -*- coding: utf-8 -*-
"""
Inference script for the SERD stage-2 conditional VE-SDE diffusion model.
...
def build_parser():
    parser = argparse.ArgumentParser(
        description="DDP inference for SERD stage-2 conditional VE-SDE diffusion"
    )
    ...
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="./outputs/checkpoints/serd_v1/vesde_physcond_serd_v1_stage2_fcrps_best.pth",
        help="Training checkpoint path, e.g. vesde_physcond_serd_v1_stage2_fcrps_best.pth or latest_full.pth.",
    )

    parser.add_argument(
        "--output_root",
        type=str,
        default="./outputs/predictions/serd_v1/stage2_serd",
