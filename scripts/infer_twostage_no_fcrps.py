# -*- coding: utf-8 -*-
"""
Inference script for the Table 2 two-stage residual diffusion without fCRPS model.
...
def build_parser():
    parser = argparse.ArgumentParser(
        description="DDP inference for Table 2 two-stage residual diffusion without fCRPS"
    )
    ...
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="./outputs/checkpoints/twostage_no_fcrps/vesde_physcond_twostage_no_fcrps_best.pth",
        help="Training checkpoint path, e.g. vesde_physcond_twostage_no_fcrps_best.pth or latest_full.pth.",
    )

    parser.add_argument(
        "--output_root",
        type=str,
        default="./outputs/predictions/twostage_no_fcrps",
